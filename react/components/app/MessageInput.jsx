...
const MessageInput = React.memo(({onMessageSend,isMessageSending})=>{
    ...
    return (
        <div className='sticky bottom-0 w-full bg-white z-40 flex items-center justify-center dark:bg-[#1b1c1d] pb-4'>
            <motion.div
